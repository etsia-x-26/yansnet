      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Featured Header (Frameless Banner) - Static for now or make dynamic later
              Stack(
                children: [
                   Container(
                    height: 180,
              ...
              Padding(
                ...
                child: Text('Upcoming Events', style: GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(height: 8),
                            ...
                            children: [
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: event.bannerUrl != null && event.bannerUrl!.isNotEmpty 
                                      ? NetworkImage(event.bannerUrl!) as ImageProvider
                                      : const AssetImage('assets/images/onboarding_collaborate.png'),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                              ...
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: event.isAttending ? Colors.grey[300] : const Color(0xFF1313EC),
                                  foregroundColor: event.isAttending ? Colors.black : Colors.white,
                                  elevation: 0,
